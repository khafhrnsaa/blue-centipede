...
ctx.moveTo(this.parent.x, this.parent.y);
ctx.lineTo(this.x, this.y);
ctx.strokeStyle = 'blue';  // This line is optional if using the CSS class
ctx.stroke();

// For the head (assuming it's drawn as an arc)
ctx.beginPath();
ctx.arc(this.x, this.y, r, 0, 2 * Math.PI);
ctx.fillStyle = 'lightblue';  // This line is optional if using the CSS class
ctx.strokeStyle = 'blue';  // This line is optional if using the CSS class
ctx.fill();
ctx.stroke();

// For the legs (if applicable)
ctx.beginPath();
ctx.moveTo(legStartX, legStartY);
ctx.lineTo(legEndX, legEndY);
ctx.strokeStyle = 'skyblue';  // This line is optional if using the CSS class
ctx.stroke();  
